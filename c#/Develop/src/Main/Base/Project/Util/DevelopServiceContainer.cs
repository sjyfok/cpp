...
namespace ICIDECode.Develop
{
	...
	/// </summary>
    public  sealed class DevelopServiceContainer : IServiceProvider, IServiceContainer, IDisposable
    {
        ...
        public DevelopServiceContainer()
        {
            services.Add(typeof(DevelopServiceContainer), this);
