    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void findByNameClick(object sender, RoutedEventArgs e)
        {
            ...
            if(!String.IsNullOrEmpty(text))
            {
                ...
                PhoneNumber personPhoneNumber =
                    this.phoneBook[personName];
                phoneNumber.Text = String.IsNullOrEmpty
                    (personPhoneNumber.Text) ?
                    "Not found" : personPhoneNumber.Text;
            }
        }
        ...
        private void findByPhoneNumberClick(object sender, RoutedEventArgs e)
        {
            ...
            if(!String.IsNullOrEmpty(text))
            {
                ...
                Name personsName = this.phoneBook
                    [personsPhoneNumber];
                name.Text = String.IsNullOrEmpty(
                    personsName.Text) ?
